...
- **Streaming replies with Stop** — type a question and press `Enter`; press `Enter` again (or click Stop) to cancel a running reply. Assistant replies render **Markdown** (GitHub-style styling), while the panel layout and chat input stay unchanged.
